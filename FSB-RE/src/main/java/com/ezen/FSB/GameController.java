...
//		}
	...
	// 이름 순, 인원 순, (임시 난이도순 추후에 별점순으로 고칠 예정), 좋아요 순 정렬
	...
	public ModelAndView memReportOk(HttpServletRequest req, @ModelAttribute ReportDTO dto, @RequestParam int mem_report) {
		System.out.println("신고 mem_num" + dto.getMem_num());
		System.out.println("대상자"+dto.getReport_target());
	...
	public ModelAndView game_tag(int game_num) {
		System.out.println("피드용 게임넘버 들고왔니"+game_num);
