...
<head>
  ...
  <link href="resources/NiceAdminassets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="resources/NiceAdminassets/vendor/simple-datatables/style.css" rel="stylesheet">
...
<body>
   ...
   <ul class="nav nav-tabs">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0 show" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="board_free.do?mode=">
                <span>자유게시판</span>
              </a>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="board_secondhand.do?mode=all">
                <span>중고게시판</span>
              </a>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="board_anony.do?mode=anony">
                <span>익명게시판</span>
              </a>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="map.do">
                <span>보드게임 매장 지도</span>
              </a>
              </li>
          </ul>
